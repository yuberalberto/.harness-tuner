...
description: >
  Find deepening opportunities in a codebase informed by domain language (CONTEXT.md)
  and architectural decisions (docs/adr/). Propose refactors that turn shallow modules
  into deep ones for better testability and AI-navigability.
