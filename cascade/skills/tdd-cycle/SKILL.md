---
name: tdd-cycle
description: Test-driven development with vertical slicing, Engram saves, and spec documentation. One test → one implementation → repeat. Planning confirms interface + behaviors. Engram saves at approval and completion. Document in Spec updates criteria and graph.
---
...
3. Update the Dependency Graph at the top of the spec with a ✅ mark next to
   this task
4. Update `.scratch/<feature>/INDEX.md` (if it exists) — change this issue's
