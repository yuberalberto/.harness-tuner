---
name: to-prd
description: Synthesize the current conversation context and codebase understanding into a PRD. Outputs to `.scratch/<feature>/PRD.md` for local markdown-based tracking.
---

# To PRD

Turn the current conversation context into a PRD and publish it to `.scratch/<feature>/PRD.md`.
...
Write the PRD using the template below, then publish it to `.scratch/<feature>/PRD.md`.
...
Create `.scratch/<feature>/` if needed, then write `.scratch/<feature>/PRD.md`
